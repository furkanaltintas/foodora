...
const Index = ({ food }) => {
    ...
    const handleClick = () => {
        dispatch(
            addProduct({ ...food, extras, price, quantity: 1 })
        );
    }
    ...
    return (
        <div className="flex items-center md:h-[calc(100vh_-_88px)] gap-5 py-20 flex-wrap ">
            <div className="relative md:flex-1 md:w-[60%] md:h-[60%] w-36 h-36 mx-auto">
            ...
            <div className="md:flex-1 md:text-start text-center">
                        ...
                        food.category === "pizza" && (
                            <>
                                ...
                                <div className="flex items-center gap-x-20 md:justify-start justify-center">
                                    ...
                                    >
                                        <Image src="/images/size.png" alt="" layout="fill" className="hover:scale-125 transition-all duration-300" />
                ...
                <button
                    ...
                    onClick={handleClick}
                    disabled={findCart}>Add to Cart</button>
            </div>
        </div>
    );
};
